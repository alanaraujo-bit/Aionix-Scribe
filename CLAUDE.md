...
**Disciplina de escopo em contas com múltiplos projetos**: as contas Railway/Vercel/outras usadas neste projeto contêm outros produtos do proprietário, não relacionados ao Aionix Scribe. Listar projetos/serviços existentes é permitido apenas o suficiente para localizar ou criar corretamente a infraestrutura do Aionix Scribe. Depois de identificar o recurso correto, não investigar, auditar, modificar, corrigir ou fazer recomendações sobre outros projetos — mesmo que algo pareça digno de nota (ex.: um secret aparentemente fraco). A autorização operacional ampla concedida a este projeto vale exclusivamente para recursos do Aionix Scribe.
